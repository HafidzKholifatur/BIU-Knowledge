  ...
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        <h3>Tambah Knowledge</h3>
        <p class="text-subtitle text-muted">Form untuk membuat Knowledge baru</p>
      </div>
      <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Tambah Knowledge</li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Form Tambah Knowledge</h4>
          </div>
                ...
                <div class="row">
                  <div class="col-md-8 col-12">
                    <div class="form-group">
                      <label for="first-name-column">Judul Knowledge</label>
                  ...
                  <div class="col-md-12 col-12">
                    <div class="form-group">
                      <label for="first-name-column">Thumbnail Knowledge</label>
                      <input type="file" name="gambar" id="gambar" class="form-control" value="<?= set_value('gambar') ?>" required>
                  ...
                  <div class="col-md-12 col-12">
                    <div class="form-group">
                      ...
                      <textarea name="ringkasan" class="form-control" required><?= set_value('ringkasan') ?></textarea>
                    </div>
                  </div>
                  <div class="col-md-12 col-12">
                    <div class="form-group">
                      <label for="first-name-column">Kategori Knowledge</label>
                  ...
                  <div class="col-md-12 col-12">
                    <div class="form-group">
                      <label for="first-name-column">Isi Knowledge</label>
                      <textarea name="isi" class="form-control summernote"><?= set_value('isi') ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12 col-12">
                    <div class="form-group">
                      <div class="row">
                        <label class="col-md-2">Keyword Knowledge (untuk SEO Google)</label>
                        <div class="col-md-10">
...
<script>
  $(document).ready(function() {
    $('.summernote').summernote({
      ...
      dialogsInBody: true,
      imageList: {
        endpoint: "<?= site_url('berita/listGambar') ?>",
    ...
    $.upload = function(file) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?= site_url('berita/uploadGambar') ?>',
        contentType: false,
        cache: false,
        processData: false,
        data: out,
    ...
    $.delete = function(src) {
      $.ajax({
        method: 'POST',
        url: '<?= site_url('berita/deleteGambar') ?>',
        cache: false,
        data: {
          src: src
        },
