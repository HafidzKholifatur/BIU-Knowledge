    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Table Dokumen</h3>
                <p class="text-subtitle text-muted">Berisi dokumen yang akan ditampilkan pada page Download</p>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="justify-content-between d-flex mb-0">
                    <div class="col-md-8">
                        <h4 class="card-title">Table Dokumen</h4>
                        <p class="text-subtitle text-muted">
                            Berisi dokumen yang akan ditampilkan pada page Download
                        </p>
                    </div>
                    <div class="col-md-4">
                        <div class="justify-content-end d-flex">
                            <?php if (esc(get_user('id_role') == 1 || get_user('id_role') == 2)) : ?>
                                <a href="#<?php // echo base_url('dokumen/tambah') 
                                            ?>" class="btn btn-success"><i class="fa-solid fa-plus"></i> Tambah Dokumen</a>
                            <?php endif ?>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered" id="example1">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td>1</td>
                            <td>Dokumen 1</td>
                            <td>Deskripsi dokumen 1</td>
                            <td>
                                <a href="#" class="btn btn-info btn-sm">Button 1</a>
                                <a href="#" class="btn btn-danger btn-sm">Button 2</a>
                            </td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Dokumen 2</td>
                            <td>Deskripsi dokumen 2</td>
                            <td>
                                <a href="#" class="btn btn-info btn-sm">Button 1</a>
                                <a href="#" class="btn btn-danger btn-sm">Button 2</a>
                            </td>
