  ...
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        <h3>Edit Dokumen Download</h3>
        <p class="text-subtitle text-muted">Form untuk mengedit seputar dokumen download</p>
      </div>
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
              <form action="<?= base_url('download/edit/' . $download['id_download']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <?= csrf_field();
                ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <input type="file" name="gambar" id="gambar" class="form-control" value="<?= $download['gambar'] ?>">
                  </div>
                </div>
