    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Menampilkan Seluruh Data Kategori Yang Terdaftar Pada BIU Knowledge.</p>
            </div>
            ...
            <div class="justify-content-between d-flex mb-0">
                <div class="col-md-8">
                    ...
                    <p class="text-subtitle text-muted">
                        Menampilkan data kategori Knowledge yang ada.
                    </p>
                </div>
                <div class="col-md-4">
                    <div class="justify-content-end d-flex">
                        <button class="btn btn-success tambah"><i class="fa-solid fa-plus"></i> Tambah Kategori</button>
                    </div>
                </div>
            </div>
            <hr>
