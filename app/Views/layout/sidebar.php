    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <?php if (esc(get_user('id_role') == 1)) : ?>
                    <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            ...
                            <li class="submenu-item ">
                                <a href="<?= base_url('berita') ?>">Tabel Knowledge</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="<?= base_url('berita/tambah') ?>">Tambah Knowledge</a>
                            </li>
                        </ul>
                    </li>
                <?php endif ?>
                ...
                <?php if (esc(get_user('id_role') == 1 || get_user('id_role') == 2)) : ?>
                    <li class="sidebar-item">
                        <a href="<?= base_url('download/table') ?>" class='sidebar-link'>
